...
public class MainActivity extends FragmentActivity {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    InStreamManager.Companion.getInstance().init(this, SAMPLE_ACCOUNT_ID, DeviceType.TV, Environment.SANDBOX, 5, 5, 5, LevelLog.BODY,true, 8);

    //init welcome
    welcomeAdView = findViewById(R.id.welcome_ad_view);

    //Welcome
    AdsWelcomeManager.Companion.getInstance().init(this,  "14", DeviceType.TV, Environment.SANDBOX, 5, 5, 5, true); //TODO: them partnerSkipOffset
